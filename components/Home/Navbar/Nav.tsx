    ...
    >
      <div className="flex items-center h-full justify-between w-[90%] xl:w-[80%] mx-auto">
        ...
        <div className="flex items-center space-x-2">
          ...
          <h1 className="text-xl hidden sm:block md-2xl text-blue-800 font-bold">
            TechAshwani
          </h1>
        </div>
        {/* NavLinks */}
        <div className="hidden lg:flex items-center space-x-10">
          {NavLinks.map((link) => (
            <p
              key={link.id}
              className="text-black hover:text-rose-500 font-semibold transition-all duration-200 cursor-pointer"
              onClick={(e) => {
                e.preventDefault();
        ...
        <div className="flex items-center space-x-4">
          ...
          <HiBars3BottomRight
            ...
            area-label="Open Mobile navigation"
          />
        </div>
      </div>
    </div>
