...
const ClientReview = () => {
  return (
    <div id="review" className='scroll-mt-[12vh] pt-16 pb-16 bg-gray-100 '>
        {/* Heading */}
      <h1 className='text-center text-2xl text-blue-950 font-bold'>What Our Happy Client Says</h1>
      {/* Sub Heading */}
      <p className='mt-3 text-center font-medium text-gray-700 w-[90%] mx-auto sm:w-[70] md:w-[50%]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus magnam pariatur commodi maiores consequuntur a.</p>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 items-center mt-16 w-[80%] mx-auto '>
        <div data-aos="zoom-in" data-aos-anchor-placement="top-center">
            <ClientReviewCard 
              ...
              name="Jasica Doe"
              rating="4.7"
              descr="Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto rerum recusandae sint quisquam ullam quo."
            />
        </div>
