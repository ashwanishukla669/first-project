...
const Hero = () => {
  return (
    <div id="home" className='relative w-full h-[110vh] sm:h-screen  bg-[url("/images/bg.png")] bg-cover bg-center flex justify-center flex-col'>
      <div className="w-[90%] md:w-[80%] mx-auto items-center grid grid-cols-1 xl:grid-cols-2 gap-2">
        ...
        <div className="" data-aos="fade-up">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl mt-6 mb-6 font-bold text-blue-950 leading-[2.5rem] md:leading-[2.5rem]">
            Kickstart, Scale, and Thrive Faster with{" "}
            <span className="text-rose-700">TechAsh</span>
          </h1>
          <p className="text-xs sm:text-sm md:text-base font-medium text-gray-700">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita
            dolorem odit velit illo incidunt impedit ipsa ullam repellendus,
            sequi provident
          </p>
          ...
          <div className="flex sm:flex-row flex-col sm:items-center sm:space-x-10 mt-6">
            ...
            <div className="flex mt-6 sm:mt-0 items-center space-x-4">
              <Image src="/images/linkedin.png" width={40} height={40} alt="" />
              <div>
                <div className="flex items-center space-x-2">
                  <h1 className="text-lg sm:text-xl md:text-2xl text-gray-700 font-bold">
                    4.7
