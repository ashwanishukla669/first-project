...
const Team = () => {
  return (
    <div id="team" className='scroll-mt-[12vh] pt-16 pb-16'>
      <div className='w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-5 gap-10 items-center'>
        ...
        <div className='lg:col-span-2'>
            ...
            {/* Description */}
            <p className='mt-4 text-gray-700'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident voluptas quod mollitia vitae minus laborum, temporibus nostrum culpa impedit maiores</p>
            <div className='mt-8'>
    ...
    <span className="relative">Join Our Team</span>
        ...
        <div className='sm:flex items-center space-y-4 sm:space-y-0 sm:space-x-4 lg:col-span-3'>
          <div data-aos="fade-right" data-aos-anchor-placement="top-center" className='relative overflow-hidden'>
